export type DetailCategory = { title: string; items: string[] };
...
export const renovationService: ServiceItem = {
  id: "renovation",
...
export const plomberieService: ServiceItem = {
  id: "plomberie",
  title: "Plomberie",
...
export const electriciteService: ServiceItem = {
  id: "electricite",
...
export const toitureService: ServiceItem = {
  id: "toiture",
  title: "Toiture",
